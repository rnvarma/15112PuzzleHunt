...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Puzzle.image_link'
        db.add_column(u'backend_puzzle', 'image_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Puzzle.image_link'
        db.delete_column(u'backend_puzzle', 'image_link')
    ...
    models = {
        ...
        u'backend.puzzle': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_link': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300'}),
